require.config({
    ...
    paths: {
        ...
        'jquery.mobile': './vendor/jQuery_mobile/jquery.mobile-1.4.3',
        'chris.application': './js/chris.application-2.1.5',
        ...
        'headroom':  './vendor/headroom/headroom'
    },
...
require(['jquery', 'chris.application', 'chris.library', 'collapse'], function($, application, library) {
    ...
    $(document).on('pageshow', '[data-role=page]', function(event, ui) {
        ...
        application.initializeHeadroom();
