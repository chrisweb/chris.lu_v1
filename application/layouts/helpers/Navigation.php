...
class Application_Layouts_Helpers_Navigation extends Zend_View_Helper_Abstract {
    ...
    function navigation() {
        ...
        $playlistsClass = ($moduleName == 'playlist') ? ' class="active"' : '';
		...
		$navigation .= '<ul class="nav">';
            ...
            $navigation .= '<li'.$readinglistClass.'><a href="/myreadinglist" data-transition="flip">'.$this->view->translate('MYREADINGLIST').'</a></li>';
            $navigation .= '<li id="last"'.$playlistsClass.'><a href="/myplaylists" data-transition="flip">'.$this->view->translate('MYPLAYLISTS').'</a></li>';
		$navigation .= '</ul>';
